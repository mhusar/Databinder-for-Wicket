...
public class HibernateListModel<T> extends LoadableDetachableModel<List<T>> {
	 ...
	 */
	public HibernateListModel(Class<T> itemClass, String queryString) {
		this(new QueryBinderBuilder<T>(itemClass, queryString));
	}
	 ...
	 */
	public HibernateListModel(Class<T> itemClass, String queryString, final boolean cacheable) {
		this(itemClass, queryString, new QueryBinder<T>() { // TODO: maybe use 'super type token' pattern here instead of itemClass
			public void bind(Query<T> query) {
	 ...
	 */
	public HibernateListModel(Class<T> itemClass, String queryString, QueryBinder<T> queryBinder) {
		this(new QueryBinderBuilder<T>(itemClass, queryString, queryBinder));
	}
	 ...
	 * @param itemClass the class of the list items
	 */
	public HibernateListModel(Class<T> itemClass) {
		this.itemClass = itemClass;
	}

	/**
	 * Constructor for a list of results in class matching a built criteria.
	 * @param itemClass class for root criteria
	 * @param criteriaBuilder builder to apply criteria restrictions
	 */
	public HibernateListModel(Class<T> itemClass, CriteriaBuilder criteriaBuilder) {
		this.itemClass = itemClass;
	 ...
	 */
	public HibernateListModel(QueryBuilder<T> queryBuilder) {
