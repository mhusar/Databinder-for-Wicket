...
public class PackagedResourceReference extends WebMarkupContainer
{
		...
		IModel<String> srcReplacement = new Model<String>()
		{
			...
			public String getObject()
			{
				...
				ResourceReference ref = 
						new PackageResourceReference(referer, f, getLocale(), getStyle(), "");
				CharSequence url = urlFor(ref, null);
				return url != null ? url.toString() : null;
			}
		};
		add(new AttributeModifier(attributeToReplace, srcReplacement));
	}
	...
	protected ResourceReference createPackageResourceReference(Application app, Class<?> scope,
		String name)
	{
		ResourceReference resourceReference = new PackageResourceReference(scope, name);
